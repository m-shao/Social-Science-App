  ...
  return (
    <div className="article-div">
        ...
        <div className="article-section">
            ...
            <p>Les résultats du expériences observait que plus qu’un tiers du temps les participants étaient en accord avec le groupe, et plus que 75% ont dû s'y conformer au moins une fois. Dans le groupe de contrôle, moins d'un pourcent des participants ont eu la réponse incorrecte.</p>
            <p>Les participants ont dû se conformer pour 2 raisons selon asch, parce qu'ils veulent s'intégrer au groupe (influence normative) ou parce qu'ils pensaient que le groupe était plus correct qu'eux (influence informationnelle).</p>
            <p>Une variation alternative de cette expérience inclut un "allié" du participant. Un autre acteur parmi les 7 qui aura la réponse correcte. Asche Observe It qu’avec seulement 1 personne qui est avec vous seulement le pourcentage de personnes qui conforme tombe à seulement 5%. Les personnes qui participaient dans ses textes ont dit qu’ils avaient un bon sentiment envers l'allié mais ont refusé leur influence sur leur propre décision.</p>
        </div>
        <div className="article-section">
